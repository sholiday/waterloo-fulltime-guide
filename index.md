...
Please [fork](https://github.com/sholiday/waterloo-fulltime-guide) and submit a pull request if you have something to add!
...
Note that even as a co-op student, it can take a while (up to a few months) to find a full-time position if you end up not returning to a previous employer, for whatever reason. Keep applying, keep learning, keep trying - persistence and confidence is key. You will find a job in time - everyone does, in some way or another. And when the offers start to come in, try to keep things in perspective. Yes, choosing your first full-time job is an important decision, but it is not forever. Think of it as a step towards building your career.
...
Always negotiate. For many of us it's hard to negotiate because the offers are often quite lucrative. It can seem like more than we deserve. But if you don't negotiate you can be leaving [a lot of money on the table](http://lifehacker.com/5968375/not-negotiating-your-starting-salary-could-cost-you-500000)).

If having more money to save for a house or family isn't enough of a motivator, there are [other reasons](http://lifehacker.com/why-you-should-never-be-afraid-to-negotiate-a-higher-sa-1477953403) to negotiate.
...
Recruiters are really good at negotiation and scaring people into accepting. Stephen has had friends that just took the first offer given over the phone and friends who have given into the pressure of an 'exploding offer.' Joel Spolsky of StackOverflow fame has written [a nice article on exploding offers](http://www.joelonsoftware.com/items/2008/11/26.html).
...
-	[Getting To Yes](http://www.amazon.ca/Getting-Yes-Negotiate-Agreement-Without/dp/0743526937): This book doesn't cover employment negotiation specifically, but negotiation in general. This book is especially helpful for those who don't wish to negotiate like a used car salesperson.
...
-	[An Introduction to Stock & Options](http://blog.dweek.ly/introduction-to-stock-options-startup-founder-entrepreneur-employee/)[Scribd](http://www.scribd.com/doc/55945011/An-Introduction-to-Stock-Options-for-the-Tech-Entrepreneur-or-Startup-Employee) [PDF](http://stocks.pbworks.com/f/Intro+to+Stock+and+Options.pdf)
-	[When to Exercise Stock Options](https://blog.wealthfront.com/when-to-exercise-stock-options/)
...
-	[Strategies for Canadians with U.S. retirement plans](https://www.sunnet.sunlife.com/files/advisor/english/PDF/IRA_401k_to_RRSP.pdf) by Sun Life Financial [PDF]
...
-	[Founder's Wiki: US Immigration](http://founderswiki.com/wiki/US_immigration)
...
-	[CBP: TN Overvieww](https://www.cbp.gov/travel/canadian-and-mexican-citizens/traveling-tn-or-l1-visa-canada#)
...
[CreditKarma](https://www.creditkarma.com) and [NerdWallet](https://www.nerdwallet.com) are your friends once you have established some form of credit.
...
If you move to the states for work and no longer have [residential ties](http://www.cra-arc.gc.ca/tx/nnrsdnts/cmmn/rsdncy-eng.html) (a house, spouse, or dependants), you will probably be considered a non-resident and an [emigrant](http://www.cra-arc.gc.ca/tx/nnrsdnts/ndvdls/lvng-eng.html#mgrnt) by Canada. You will owe Canada taxes on your global income before the date you became a non-resident, and you will owe taxes on only your Canadian income after you become a non-resident. You will want to give [this page](http://www.cra-arc.gc.ca/tx/nnrsdnts/ndvdls/lvng-eng.html#mgrnt) a thorough read before declaring yourself a non-resident.

### Savings Accounts

#### RRSPs

The IRS [recognizes the tax-deferred status of Canadian RRSPs](https://www.irs.gov/uac/newsroom/irs-simplifies-procedures-for-favorable-tax-treatment-on-canadian-retirement-plans-and-annual-reporting-requirements), so they will continue to be tax sheltered after you move (you will, however, have to disclose your account and it's value to the IRS). You [may continue to contribute to your RRSP after your become a non resident](http://www.moneysense.ca/save/investing/rrsp/i-dont-live-in-canada-can-i-still-invest-in-rrsps/), however, you will generally not accrue any more room from your American employment.

#### TFSAs

As of 2017, *the IRS does not recognize the tax defered status of TFSAs* so you will be taxed on any income in your TFSA ([source](http://www.huffingtonpost.ca/cleo-hamel/taxfree-in-canada-doesnt-_b_9017062.html)). Additionally, you can not contribute to your TFSA once you become a non-resident (if you do, you will be [taxed at 1% a month by the Canadian Government](http://www.cra-arc.gc.ca/tx/ndvdls/tpcs/tfsa-celi/lgbl-eng.html)\)
...
A 401(k) is an employer-sponsored retirement plan that allows you to contribute a % of your income to some account managed automatically by a financial company like Vanguard. The money is automatically deducted from your paychecks. The yearly contribution limit changes, but was $18,000 as of 2017 (up to date numbers available [from the IRS](https://www.irs.gov/retirement-plans/plan-participant-employee/retirement-topics-401k-and-profit-sharing-plan-contribution-limits)). One thing to note is that if your employer offers any 401(k) matching, you should definitely sign up for it ASAP, it's free money.

An IRA is an individually managed retirement account, usually through the same financial companies that would manage your 401(k). It is useful for individuals working at companies that might not have a 401(k) plan, like in many startups. The major disadvantages of contributing through an IRA is that you need to personally manage it more closely than a 401(k) and the contribution limit is $5,500 as of 2017 (up to date numbers available [from the IRS](https://www.irs.gov/retirement-plans/plan-participant-employee/retirement-topics-ira-contribution-limits)), which is significantly lower than a 401(k).
...
It's also important to note that, as of 2017, Roth IRA contribution limits are reduced for singles earning over $118,000 or maried couples earning over $186,000 (up to date numbers available [from the IRS](https://www.irs.gov/retirement-plans/plan-participant-employee/retirement-topics-ira-contribution-limits)). As of 2017, there is a ["backdoor" method](http://www.rothira.com/what-is-a-backdoor-roth-ira) that still allows those earning over the limit to contribute to a Roth IRA.
...
If you have a G in Ontario you still need to take the written and road test. [more info for CA](http://www.dmv.ca.gov/dl/dl_info.htm#two500).
